...
output "postdeploy_eb_arn" {
  value = aws_lambda_function.postdeploy_eb.arn
}

output "postdeploy_eb_function_name" {
  value = aws_lambda_function.postdeploy_eb.function_name
}